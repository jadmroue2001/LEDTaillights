# 1 "/Users/jadmroue/Documents/Arduino/projects/taillights/taillights.ino"
# 2 "/Users/jadmroue/Documents/Arduino/projects/taillights/taillights.ino" 2
...
void setup()
{
  ...
  pinMode(INPUTBrake, 0x00);
  pinMode(INPUTSignal, 0x00);
  pinMode(INPUTNight, 0x00);
  pinMode(INPUTNight, 0x00);
}
...
void loop()
{
  ...
  char IBrakes = Brakes == 0x1;
  char ISignal = Signal == 0x1;
  char IReverse = Reverse == 0x1;
  char INight = Night == 0x1;
